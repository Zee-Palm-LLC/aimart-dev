  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PersistentTabView(
        ...
        backgroundColor: CustomColors.kfullWhite,
        ...
        decoration: NavBarDecoration(
          colorBehindNavBar: CustomColors.kfullWhite,
        ),
...
class NotificationIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: 0,
      right: 0,
      child: notification ? Container(
        padding: EdgeInsets.symmetric(horizontal: 6.h, vertical: 2.w),
        decoration: BoxDecoration(
            shape: BoxShape.circle, color: CustomColors.kalert),
        alignment: Alignment.center,
      ): const  SizedBox(),
    );
  }
